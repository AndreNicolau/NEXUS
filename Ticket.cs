...
namespace NEXUS
{
    internal class Ticket
    {
        ...
        public void InsertAction(string TicketNumber, string Description)
        {
            ...
            OdbcCommand command = new OdbcCommand($"INSERT INTO ticket_actions (associated_ticket_number, description, date) VALUES ('{TicketNumber}', '{Description}', '{DateTime.Now.ToString("dd/MM/yyyy HH:mm")}')", connection);
        ...
        {
            string closeDate = DateTime.Now.ToString("yyyy/MM/dd HH:mm");
